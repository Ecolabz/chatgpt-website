...
function App() {
  ...
  const handleSend = () => {
    ...
    setLoading(true);
    axios
      .post("https://chatbot-ogai.onrender.com/chat", {
        question,
      })
      .then((response) => {
    ...
    <main class="main-container">
      <div>
        <div class="c">
          ...
          <div class="p">
            <p>What is Twitter and how does it work?</p>
          </div>
          <div class="p">
        ...
        <div class="c">
          ...
          <div class="p">
            <p>
            What is clear and effective copy in email marketing?
            </p>
          </div>
          <div class="p">
            <p>
            How can I write clear and effective copy for my email marketing campaigns?
            </p>
          </div>
          <div class="p">
            <p>
            What is email performance and why is it important to measure?
            </p>
          </div>
          <div class="p">
            <p>
